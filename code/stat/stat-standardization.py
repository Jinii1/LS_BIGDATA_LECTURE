...
# # 표본정규분포
# # 정의: 모집단에서 여러개의 표본을 추출하여 표본 평균 계산, 그 각각의 표본 평균들이 이루는 분포
# (Mu, sigma/np.sqrt(n)) 모집단 표준편차/np.sqrt(표본크기) -> 표본오차

# 중심극한정리
# 정의: 표본크기가 크면 모집단의 분포가 어떠하든 표본 평균의 분포는 정규분포
...
============================================================================================
## t 분포
# X ~ t(df) 베르누이처럼 모수가 하나, 연속형 확률변수, 정규분포랑 비슷하게 생김
# -> 종모양, 대칭분포, 중심 0
