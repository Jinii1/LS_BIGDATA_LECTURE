...
# NaN 값 확인
print(f'NaN in train_predict: {np.isnan(train_predict).sum()}')
print(f'NaN in test_predict: {np.isnan(test_predict).sum()}')
print(f'NaN in Y_train_seq_inv: {np.isnan(Y_train_seq_inv).sum()}')
print(f'NaN in Y_test_seq_inv: {np.isnan(Y_test_seq_inv).sum()}')