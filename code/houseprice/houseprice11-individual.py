...
rf_model= RandomForestRegressor(n_estimators=100) # 트리 개수(부트스트랩이여기에담겨있다?)

# 그리드 서치 for ElasticNet
param_grid={
    'alpha': [0.1, 1.0, 10.0, 100.0], # 규제 강도 결정 hyperparameter
    'l1_ratio': [0, 0.1, 0.5, 1.0] # L1, L2 비율 조정 hyperparameter (0: RidgeL2, 1:LassoL1)
}
