...
# 2. 전체 변수의 중요도 시각화 (Summary Plot)
shap.summary_plot(shap_values, X_test)

# 3. 각 변수의 SHAP 값 분포 시각화 (Bar Plot)
shap.summary_plot(shap_values, X_test, plot_type="bar")

# 4. 특정 데이터 샘플에 대한 Force Plot (개별 예측 설명)
...
# 5. 특정 변수에 대한 Partial Dependence Plot (PDP)
